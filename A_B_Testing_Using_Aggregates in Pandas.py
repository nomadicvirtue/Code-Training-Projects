...
a_clicks_pivot['percentage'] = ((a_clicks_pivot[True] / (a_clicks_pivot[True] + 
...
b_clicks_pivot['percentage'] = ((b_clicks_pivot[True] / (b_clicks_pivot[True] + 
